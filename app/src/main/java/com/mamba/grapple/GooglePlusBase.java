 ...
 */
public abstract class GooglePlusBase extends Activity
        implements GooglePlayServicesClient.ConnectionCallbacks,
        GooglePlayServicesClient.OnConnectionFailedListener {

    private static final String TAG = GooglePlusBase.class.getSimpleName();
    ...
    /**
     * Sign out the user (so they can switch to another activity_account).
     */
    public void signOut() {

        // We only want to sign out if we're connected.
        if (mPlusClient.isConnected()) {
            // Clear the default activity_account in order to allow the user to potentially choose a
            // different activity_account from the activity_account chooser.
    ...
    public void revokeAccess() {
        ...
        if (mPlusClient.isConnected()) {
            // Clear the default activity_account as in the Sign Out.
            mPlusClient.clearDefaultAccount();
    ...
    public void onConnectionFailed(ConnectionResult result) {
        ...
        if (result.hasResolution()) {
            ...
            if (mAutoResolveOnFail) {
                ...
                // which may be showing the user an activity_account chooser or similar.
                startResolution();
            }
        }
    }
